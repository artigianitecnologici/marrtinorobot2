...
echo "export MARRTINOROBOT2_WEBI=$HOME/src/marrtinorobot2/marrtinorobot2_webinterface/www" >> /home/ubuntu/.bashrc
echo "export MARRTINOROBOT2_WS=$HOME/marrtinorobot2_ws" >> /home/ubuntu/.bashrc

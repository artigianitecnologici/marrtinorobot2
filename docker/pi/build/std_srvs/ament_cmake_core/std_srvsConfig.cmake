...
if(_std_srvs_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED std_srvs_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(std_srvs_FOUND FALSE)
...
set(_std_srvs_CONFIG_INCLUDED TRUE)

# output package information
if(NOT std_srvs_FIND_QUIETLY)
  message(STATUS "Found std_srvs: 5.3.5 (${std_srvs_DIR})")
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "Package 'std_srvs' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT ${std_srvs_DEPRECATED_QUIET})
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(std_srvs_FOUND_AMENT_PACKAGE TRUE)

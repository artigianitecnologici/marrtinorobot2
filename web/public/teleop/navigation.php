    ...
    window.onload = function () {
      ...
      video = document.getElementById('video');
	   // Populate video source 
         ...
         //video.src = 'http://' + window.location.hostname +':8080/stream?topic=/rgb/image_raw&type=mjpeg&quality=100';
         video.src = 'http://localhost:8080/stream?topic=/image_raw'

         //src="/stream?topic=/image_raw"
